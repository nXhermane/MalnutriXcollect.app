...
const LenghtField: QuantityField = {
  type: 'quantity',
...
export const anthropometryMeasuresForm: FormSection[] = [
  {
    ...
    fields: [WeightField, HeightField, LenghtField, MUACField, HeadCirField, TSFField, SSFField],
  },
];
export function getAnthropometryFormField(
  ...
  switch (code) {
    ...
    case AnthroSystemCodes.LENGTH:
      return [
        { ...LenghtField, ...(!withCondition && { condition: undefined, alwaysShow: true }) },
      ];
